...
public class StudentController {
    ...
    public void addStudent(int nim, String name, String major) {
        if (nim <= 0 || name == null || name.isBlank() || major == null || major.isBlank()) {
            throw new IllegalArgumentException("NIM harus > 0 dan Nama/Prodi tidak boleh kosong");
        }
